  ...
  return (
    <footer className="relative bg-[#0A0A0A] text-white overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-96 h-96 bg-[#70C285]/5 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#3D8F52]/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-2xl font-bold bg-gradient-to-r from-[#70C285] to-[#3D8F52] bg-clip-text text-transparent">
                RS-Commerce
              </h3>
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  key={i}
                  href="#"
                  className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-[#70C285] hover:border-[#70C285]/30 hover:bg-[#70C285]/10 transition-all group"
          ...
          <div>
            ...
            <ul className={`mt-4 space-y-3 md:block ${openSections.quickLinks ? 'block' : 'hidden'}`}>
              {[
                ...
                <li key={i}>
                  <Link href={link.href} className="text-gray-400 hover:text-[#70C285] transition-colors text-sm flex items-center gap-2 group">
                    <span className="w-1 h-1 rounded-full bg-gray-600 group-hover:bg-[#70C285] transition-colors" />
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className={`mt-4 space-y-4 md:block ${openSections.contact ? 'block' : 'hidden'}`}>
              <li>
                <a href="https://www.google.com/maps?q=31.405349,73.104911" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 text-gray-400 hover:text-[#70C285] transition-colors group">
                  <div className="w-8 h-8 rounded-lg bg-[#70C285]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#70C285]/20 transition-colors">
                    <svg className="w-4 h-4 text-[#70C285]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <a href={`mailto:${location.email}`} className="flex items-center gap-3 text-gray-400 hover:text-[#70C285] transition-colors group">
                  <div className="w-8 h-8 rounded-lg bg-[#70C285]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#70C285]/20 transition-colors">
                    <svg className="w-4 h-4 text-[#70C285]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <a href={`tel:${location.phone.replace(/\s/g, '')}`} className="flex items-center gap-3 text-gray-400 hover:text-[#70C285] transition-colors group">
                  <div className="w-8 h-8 rounded-lg bg-[#70C285]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#70C285]/20 transition-colors">
                    <svg className="w-4 h-4 text-[#70C285]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex items-center gap-3 text-gray-400">
                <div className="w-8 h-8 rounded-lg bg-[#70C285]/10 flex items-center justify-center flex-shrink-0">
                  <svg className="w-4 h-4 text-[#70C285]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3">
                <div className="flex-1 relative">
                  <input
                    ...
                    required
                    disabled={loading}
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-[#70C285]/50 focus:bg-white/[0.07] transition-all text-sm disabled:opacity-50"
                  />
                </div>
                <button
                  type="submit"
                  disabled={loading}
                  className="px-6 py-3 bg-gradient-to-r from-[#70C285] to-[#3D8F52] text-black font-semibold rounded-xl hover:shadow-lg hover:shadow-[#70C285]/20 transition-all text-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 min-w-[140px]"
                >
                  {loading ? (
                    <>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} RS-Commerce. All rights reserved.
          </p>
          <div className="flex gap-6">
            <Link href="/privacy" className="text-gray-500 hover:text-[#70C285] text-sm transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms" className="text-gray-500 hover:text-[#70C285] text-sm transition-colors">
              Terms of Service
            </Link>
            <Link href="/cookies" className="text-gray-500 hover:text-[#70C285] text-sm transition-colors">
              Cookie Policy
            </Link>
          </div>
        </div>
