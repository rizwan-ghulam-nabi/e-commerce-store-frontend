...
export default function StoreLocation() {
  ...
  return (
    <section ref={sectionRef} className="w-full -mt-18 overflow-hidden">
      <div className="relative px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        ...
        <div className={`py-16 md:py-20 transition-all duration-1000 transform ${
          ...
          <div className="text-center max-w-4xl mx-auto">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-aurora/10 border border-aurora/20 text-aurora text-sm mb-6">
            ...
            <p className="text-gray-400 text-lg">
              Experience our products firsthand at our flagship store. We&lsquo;re just around the corner from Super Ideal Bakers.
            </p>
          </div>
        </div>

        {/* Content - Full Width Grid with padding */}
        <div className="grid grid-cols-1 -mt-8 lg:grid-cols-5 gap-0 pb-16 md:pb-20">
            ...
            <div className="bg-[#111] border border-white/5 rounded-3xl lg:rounded-r-none h-full">
              <div className="p-6 sm:p-8 lg:p-10 xl:p-12">
                ...
                <div className="flex items-center justify-between mb-8">
                  ...
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-emerald/10 border border-emerald/20 rounded-full">
                    <span className="w-2 h-2 bg-emerald rounded-full" />
                    <span className="text-emerald text-xs font-medium">Open</span>
                  </div>
                </div>
                  ...
                  {['info', 'hours', 'contact'].map((tab) => (
                    <button
                      ...
                      className={`flex-1 py-3 text-sm font-medium rounded-lg transition-all duration-300 ${
                        activeTab === tab
                          ? 'bg-gradient-to-r from-aurora to-amethyst text-white shadow-lg'
                ...
                <div className="min-h-[200px]">
                  {activeTab === 'info' && (
                    <div className="space-y-4 animate-slideUp">
                      <div className="flex items-start gap-4 p-4 bg-white/[0.02] rounded-xl hover:bg-white/[0.04] transition-colors">
                        <div className="w-12 h-12 rounded-xl bg-aurora/10 flex items-center justify-center flex-shrink-0">
                  ...
                  {activeTab === 'hours' && (
                    <div className="space-y-4 animate-slideUp">
                      <div className="flex items-center justify-between p-4 bg-aurora/5 border border-aurora/10 rounded-xl">
                        <span className="text-gray-300">Monday - Saturday</span>
                        <span className="font-medium text-aurora">9:00 AM - 9:00 PM</span>
                      </div>
                      <div className="flex items-center justify-between p-4 bg-white/[0.02] rounded-xl">
                        <span className="text-gray-300">Sunday</span>
                        <span className="font-medium text-gray-400">11:00 AM - 7:00 PM</span>
                      </div>
                    </div>
                  )}
                  ...
                  {activeTab === 'contact' && (
                    <div className="space-y-4 animate-slideUp">
                      ...
                      >
                        <div className="w-12 h-12 rounded-xl bg-aurora/10 flex items-center justify-center group-hover:scale-110 transition-transform">
                          <svg className="w-6 h-6 text-aurora" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="grid grid-cols-2 gap-4 mt-8 pt-8 border-t border-white/5">
                  <a
                    ...
                    className="group relative overflow-hidden bg-gradient-to-r from-aurora to-amethyst text-white font-semibold py-4 px-6 rounded-xl text-center hover:shadow-lg hover:shadow-aurora/25 transition-all"
                  >
                  ...
                  <a
                    href={`tel:${location.phone.replace(/\s/g, '')}`}
                    className="group relative overflow-hidden bg-white/5 border border-white/10 text-white font-semibold py-4 px-6 rounded-xl text-center hover:border-aurora/30 hover:bg-white/[0.07] transition-all"
                  >
                    <span className="relative z-10 flex items-center justify-center gap-2">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative h-[400px] lg:h-full min-h-[500px] border border-white/5 rounded-3xl lg:rounded-l-none overflow-hidden">
              ...
              <div className="absolute top-6 left-6 bg-black/90 backdrop-blur-xl border border-white/10 rounded-2xl p-5 max-w-[220px] hover:scale-105 transition-transform duration-300">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <span className="text-white text-sm font-bold block">SwiftCart</span>
                    <span className="text-aurora text-xs">📍 Store Location</span>
                  </div>
                </div>
              ...
              <div className="absolute bottom-6 right-6 flex gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-black/90 backdrop-blur-xl border border-white/10 text-white text-xs px-4 py-2.5 rounded-xl hover:bg-black hover:border-aurora/30 transition-all"
                >
