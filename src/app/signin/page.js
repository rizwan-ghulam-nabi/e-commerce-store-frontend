 ...
 const handleSubmit = async (e) => {
  ...
  try {
    ...
    const isAdmin = formData.email.includes('admin') || 
                    formData.email === 'sheikhrizwanghulamnabi555@gmail.com'
    ...
    // Handle OTP if required (admin login)
    if (data.requiresOTP) {
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    autoComplete="email"
                    className="w-full pl-9 sm:pl-10 pr-3 py-2 sm:py-2.5 text-xs sm:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-200 text-black"
